...
tokens_new1 = toker.tokenize(news1)
tokens_new2 = toker.tokenize(news2)

print tokens_new1
print tokens_new2
# tagged_tokens_new1 = nltk.pos_tag(tokens_new1)
# tagged_tokens_new2 = nltk.pos_tag(tokens_new2)

# print tagged_tokens_new1
# print tagged_tokens_new2
